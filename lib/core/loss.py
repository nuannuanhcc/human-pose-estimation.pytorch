...
class JointsMSELoss(nn.Module):
    ...
    def forward(self, output, target, target_vis, scale, loss_norm, lamda=0.1):
        ...
        loss_all = loss_coord + lamda * loss_norm
        return loss_coord.mean(), loss_all.mean(), loss_norm.mean()
